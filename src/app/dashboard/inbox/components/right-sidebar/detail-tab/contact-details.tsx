      ...
      <div className="flex justify-between items-center">
        ...
        {hasContactInfo && (
          <div className="flex items-center gap-3">
            <span className="text-[0.75rem] text-accent-primary cursor-pointer hover:underline" onClick={onEdit}>Chỉnh sửa</span>
            <span className="text-[0.75rem] text-red-400 cursor-pointer hover:underline" onClick={onDelete}>Xóa</span>
          </div>
        )}
      </div>
      <div className="flex flex-col gap-2">
        {hasContactInfo ? (
          ...
          <>
            ...
            <button 
              className="flex items-center justify-center gap-2 w-full py-2 border border-dashed border-white/20 rounded-lg text-[0.8125rem] text-foreground-tertiary transition-all hover:border-white/40 hover:text-foreground-secondary" 
              onClick={onEdit}
            >
