  ...
  if (wsError || !workspace) {
    ...
    return (
      <div className="max-w-[1000px] mx-auto p-10 md:py-12">
        <h1 className="text-4xl font-extrabold mb-8 tracking-tight">Settings</h1>
    ...
    <div className="max-w-[1000px] mx-auto p-10 md:py-12">
      <header className="mb-12">
        <div className="flex flex-col gap-2">
          <h1 className="text-4xl font-extrabold tracking-tight bg-gradient-to-br from-foreground to-foreground-secondary bg-clip-text text-transparent m-0 mb-2">Platform Connections</h1>
        ...
        <div className="flex flex-col gap-6">
          <section className="p-6 rounded-2xl bg-foreground/[0.02] border border-foreground/10 backdrop-blur-xl">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="bg-foreground/10 px-3 py-1 rounded-full text-sm font-semibold">{accounts?.length || 0}</span>
            </div>
