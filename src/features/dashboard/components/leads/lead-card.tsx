    ...
    <>
      <div
        ...
        className={cn(
          ...
          isSelected &&
            isBulkEditing &&
            "border-sky-400 bg-sky-50/10 dark:bg-sky-950/5 shadow-xs",
        )}
      >
        <div className="flex items-center gap-3 min-w-0 flex-1">
          ...
          <div className="flex flex-col gap-1 min-w-0 flex-1">
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              {/* Badge nguồn */}
              <span className="px-2 py-0.5 bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300 rounded text-3xs font-semibold">
                {lead.source}
              </span>
              <span className="text-3xs text-base-content/40 font-medium">
                {lead.date}
              </span>
            </div>
          </div>
      ...
      {mounted &&
        ...
        createPortal(
          ...
          >
            <li className="menu-title text-3xs font-bold uppercase text-base-content/40 tracking-wider">
              Chuyển sang
            </li>
            ...
            {stages
              ...
              .map((stage) => (
                <li key={stage.id}>
                  ...
                  >
                    <span className="text-2xs">{stage.icon}</span>
                    {stage.label}
                  </button>
                </li>
              ))}
            ...
            {/* Đường ngăn cách */}
            <div className="h-px bg-base-200 dark:bg-base-800 my-1 mx-2" />
        ...
        <div className="fixed inset-0 z-300 flex items-center justify-center bg-black/45 backdrop-blur-xs animate-fade-in">
          <div className="bg-base-100 rounded-2xl p-6 max-w-[300px] w-full mx-4 shadow-xl border border-base-200 dark:border-base-800 animate-in fade-in zoom-in-95 duration-200 relative text-left">
            ...
            <p className="text-2xs leading-relaxed text-base-content/60 mb-6 font-medium">
              Khách hàng tiềm năng này sẽ bị xóa khỏi Trung tâm khách hàng tiềm
              năng. Hành động này không thể hoàn tác.
            </p>
