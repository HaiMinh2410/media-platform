    ...
    <div className="bg-[#f0f6ff] dark:bg-sky-950/20 border border-sky-100 dark:border-sky-900/20 rounded-xl py-3 px-5 flex flex-col md:flex-row justify-between items-center w-full gap-4 shadow-3xs">
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 flex-1 text-xs md:text-sm text-sky-900 dark:text-sky-300">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-bold text-[#0064d2] dark:text-sky-300 text-sm">{newLeadsCount}</span>
          <div className="relative group/tooltip flex items-center justify-center">
            <Info size={13} className="text-sky-500/80 cursor-pointer shrink-0" />
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-white dark:bg-base-100 text-base-content/85 text-[10px] leading-relaxed rounded-xl border border-base-200 dark:border-base-800 shadow-md opacity-0 pointer-events-none group-hover/tooltip:opacity-100 transition-opacity duration-300 z-50 text-center font-semibold">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-bold text-purple-600 dark:text-purple-400 text-sm">{conversionRate}</span>
          <div className="relative group/tooltip flex items-center justify-center">
            <Info size={13} className="text-sky-500/80 cursor-pointer shrink-0" />
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-white dark:bg-base-100 text-base-content/85 text-[10px] leading-relaxed rounded-xl border border-base-200 dark:border-base-800 shadow-md opacity-0 pointer-events-none group-hover/tooltip:opacity-100 transition-opacity duration-300 z-50 text-center font-semibold">
              <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-white dark:bg-base-100 border-b border-r border-base-200 dark:border-base-800 rotate-45" />
      ...
      <button className="text-[#0064d2] hover:text-[#0052ad] text-xs font-bold transition-all shrink-0 hover:underline cursor-pointer">
        Xem tất cả
      </button>
    </div>
  );
