...
export function FollowerInsufficientDataState({
  ...
  return (
    <motion.div 
      ...
      className="w-full bg-base-100 border border-base-content/5 shadow-sm rounded-3xl p-8 text-center font-sans relative overflow-hidden"
    >
      ...
      <h3 className="text-xl font-extrabold text-base-content mb-2 tracking-tight font-brand">Dữ liệu Người theo dõi hạn chế</h3>
      ...
      <div className="inline-flex flex-col items-center justify-center p-6 bg-base-200/50 border border-base-content/5 rounded-2xl mb-6 min-w-[200px] shadow-xs">
        <span className="text-xs text-base-content/40 uppercase tracking-widest font-bold mb-1 font-brand">Followers hiện tại</span>
