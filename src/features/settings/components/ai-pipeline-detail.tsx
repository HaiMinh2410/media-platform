...
Provide your output in the requested JSON format. Ensure reply and notes_for_next are in Vietnamese. If "Should Send Link" is YES, weave the "Link to Send" naturally inside your "reply" text replacing any placeholder like {{link}} or adding it elegantly.`
    ...
    },
    {
      ...
      howItWorks: [
        ...
        "Cơ chế Debounce: Nếu Fan liên tục gửi tin nhắn mới khi tin cũ đang chờ gửi, hệ thống tự động hủy job cũ và lên lịch lại, đảm bảo AI đọc được đầy đủ tin nhắn của fan trước khi rep. Có chặn giới hạn thời gian dời lịch tối đa để tránh đẩy lùi lịch rep vô hạn."
      ],
