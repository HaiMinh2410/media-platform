    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="p-6 rounded-2xl bg-foreground/[0.02] border border-foreground/10 backdrop-blur-xl flex flex-col gap-6">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-lg font-bold m-0 text-foreground">
              Workspace Context
            </h3>
            <p className="text-foreground-tertiary text-xs m-0">
              Thông tin môi trường và thông số định danh không gian làm việc.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <span className="text-foreground-tertiary text-2xs font-bold uppercase tracking-wider">
              Workspace Name
            </span>
          ...
          <div className="flex flex-col gap-1.5">
            <span className="text-foreground-tertiary text-2xs font-bold uppercase tracking-wider flex justify-between items-center">
              Workspace ID
              <span className="text-2xs text-primary lowercase italic font-normal">
                Sử dụng cho API requests
              </span>
            </span>
      ...
      <div className="p-6 rounded-2xl bg-foreground/[0.02] border border-foreground/10 backdrop-blur-xl flex flex-col gap-6">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-foreground-tertiary text-xs m-0">
              Cấu hình Endpoint và Verify Token để liên kết với Facebook
              Developers.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <span className="text-foreground-tertiary text-2xs font-bold uppercase tracking-wider flex justify-between items-center">
              Verify Token
              <span className="text-2xs text-yellow-500/80 font-normal lowercase flex items-center gap-1">
                <ShieldAlert size={10} />
                Bảo mật tuyệt đối
              </span>
            </span>
            <div className="flex gap-2">
              ...
              <button
                onClick={() =>
                  copyToClipboard(
                    verifyToken || "not_configured_token_value",
                    "token",
                  )
                }
                className="p-2.5 rounded-xl border border-foreground/10 hover:bg-foreground/5 text-foreground-secondary hover:text-foreground active:scale-95 transition-all"
          ...
          <div className="p-3 bg-yellow-500/5 border border-yellow-500/10 rounded-xl text-yellow-500/80 flex items-start gap-2.5">
            ...
            <p className="m-0 text-[11px] leading-relaxed">
              Dùng <strong>ngrok</strong> hoặc cloudflare tunnel để map cổng{" "}
              <strong>3000</strong> thành public URL nếu muốn nhận dữ liệu
              webhook trực tiếp từ Meta.
            </p>
          </div>
        </div>
      </div>
