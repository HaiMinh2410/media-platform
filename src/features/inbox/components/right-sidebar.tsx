...
export function RightSidebar({
  ...
  return (
    <aside className="flex flex-col h-full bg-background/80 border-l border-base-content/5" data-sidebar="right">
      ...
      <div className="flex items-center h-[64px] gap-1 p-2 border-b-2 border-background-secondary backdrop-blur-xl">
        ...
        <button 
          className={cn(
            ...
            isAutoReplyActive 
              ? activeTab === 'ai'
                ? "text-success bg-success/15 border border-success/30 font-bold"
                : "text-success/60 bg-success/5 border border-success/10 hover:bg-success/10 font-bold"
              : activeTab === 'ai'
      ...
      <div 
        className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-base-content/10"
