          ...
          {(message.content || isAi) && (
            <div 
              className={cn(
                ...
                isAgent && "bg-linear-to-br from-primary to-secondary text-primary-content shadow-md shadow-primary/25",
                isAi && "bg-linear-to-br from-accent/15 to-accent/5 border border-accent/35 text-foreground shadow-md shadow-accent/15 backdrop-blur-md"
              )}
            >
              {/* Main Message Text */}
              {message.content && (
