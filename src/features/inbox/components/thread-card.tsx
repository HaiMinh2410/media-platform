            ...
            {!conversation.is_pinned && (
              <div className="relative w-full h-full flex items-center justify-end overflow-hidden">
                ...
                <button
                  ...
                  disabled={isPinning}
                  className="opacity-0 translate-y-2xs group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-200 text-base-content/40 hover:text-primary hover:scale-110 p-1 rounded-full hover:bg-base-content/5 absolute right-0 flex items-center justify-center cursor-pointer border-0 bg-transparent"
          ...
          >
            {conversation.last_message_content
              ? conversation.last_message_sender_type === "agent" ||
                conversation.last_message_sender_type === "ai"
