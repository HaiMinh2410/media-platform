import { RangeSelector, FilterGroup } from "@shared/ui";
...
export function PanelHeader({
  ...
  return (
    <div className="p-[16px_20px_12px]">
      ...
      <div className="flex justify-between items-center pb-3 text-xs text-foreground-tertiary">
        <div className="font-medium text-foreground-tertiary">
          <span>{conversationsCount} items</span>
        </div>

        <FilterGroup className="rounded-full">
          {/* Filter Dropdown */}
          ...
          <div ref={sortRef} className="flex items-center -space-x-px shrink-0">
            ...
            {/* Sort Order Button */}
            <button
              className="flex items-center justify-center transition-all text-foreground-tertiary cursor-pointer p-1.5 size-6 shrink-0"
