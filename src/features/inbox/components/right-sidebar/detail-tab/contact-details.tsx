  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex justify-between items-center">
        <h3 className="font-medium text-base-content/50">Chi tiết liên hệ</h3>
        {hasContactInfo && (
        ...
        {hasContactInfo ? (
          <>
            ...
            {contactInfo?.birthday && (
              <div className="flex items-center gap-2 text-sm text-base-content/70">
                <Cake size={16} className="text-base-content/60" />
          ...
          <>
            <p className="text-sm text-base-content/60 leading-normal mb-1">Bổ sung chi tiết về người liên hệ này.</p>
            <button 
              className="flex items-center justify-center gap-2 w-full py-2 border border-dashed border-base-content/20 rounded-lg text-sm text-base-content/60 transition-all hover:border-base-content/40 hover:text-base-content/70 animate-none bg-transparent cursor-pointer" 
              onClick={onEdit}
            >
