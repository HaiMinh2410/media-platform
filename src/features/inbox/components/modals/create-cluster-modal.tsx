    ...
    <div className="fixed inset-0 z-[10000] flex items-center justify-center overflow-hidden p-4 sm:p-6">
      ...
      >
        ...
        <div className="p-6 border-b border-foreground/5 flex items-center justify-between bg-base-300/50 shrink-0">
          <div>
            <h2 className="m-0 text-xl font-bold text-foreground tracking-tight">
              Tạo cụm tài khoản
            </h2>
            <p className="text-xs text-foreground-tertiary mt-0.5">
              Nhóm các tài khoản để quản lý tập trung
            </p>
          </div>
          <button
        ...
        <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-6">
          <div className="mb-8">
            <label className="block text-xs font-bold text-foreground-tertiary mb-2.5 uppercase tracking-widest">
              Tên cụm tài khoản
            </label>
            <input
          ...
          <div className="mb-2">
            <label className="block text-xs font-bold text-foreground-tertiary mb-4 uppercase tracking-widest flex items-center justify-between">
              ...
              <span className="px-2 py-0.5 bg-primary/10 text-primary rounded-full text-2xs">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5">
                          <span
                            className={cn(
                              "text-2xs px-1.5 py-0.5 rounded-full uppercase font-bold",
