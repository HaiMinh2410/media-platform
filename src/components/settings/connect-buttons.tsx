    ...
    <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6">
      ...
      >
        <div className="flex justify-center items-center h-24 mb-6">
          <svg className="w-[60px] h-[60px] text-[#1877F2] drop-shadow-[0_0_10px_rgba(24,119,242,0.3)]" viewBox="0 0 24 24" fill="currentColor">
      ...
      >
        <div className="flex justify-center items-center h-24 mb-6">
          <svg className="w-[60px] h-[60px] text-[#E4405F] drop-shadow-[0_0_10px_rgba(228,64,95,0.3)]" viewBox="0 0 24 24" fill="currentColor">
      ...
      >
        <div className="flex justify-center items-center h-24 mb-6">
          <svg className="w-[60px] h-[60px] text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.9-.32-1.98-.23-2.81.33-.85.51-1.44 1.43-1.58 2.41-.16 1.61.47 3.38 2.34 3.38 1.57.04 2.45-1.51 2.41-2.99V.02z"/>
          </svg>
        </div>
