...
import styles from './connect-buttons.module.css';
  ...
  return (
    <div className={styles.grid}>
      ...
      >
        ...
        <Button onClick={handleConnectFacebook} fullWidth className={styles.connectBtn}>
          Connect Page
        </Button>
      </Card>
      ...
      >
        ...
        <Button onClick={handleConnectInstagram} fullWidth className={styles.connectBtn}>
          Connect IG
        </Button>
      </Card>
      ...
      >
        <div className={styles.iconWrapper}>
          <svg className={styles.tiktokIcon} viewBox="0 0 24 24" fill="currentColor">
