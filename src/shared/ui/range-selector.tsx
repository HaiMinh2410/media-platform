  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        className={
          triggerClassName ||
          `bg-foreground/5 hover:bg-foreground/10 border border-foreground/10 hover:border-foreground/20 text-foreground/90 flex items-center transition-all cursor-pointer shadow-inner shrink-0 ${currentStyle.trigger}`
        }
      >
